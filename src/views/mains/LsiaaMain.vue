...
<template>
  <div :style="{ '--bodyColor': themeVars.bodyColor }" class="relative min-h-screen bg-(--bodyColor) z-10">
    <n-layout position="absolute">
      <n-layout has-sider position="absolute">
        ...
        <n-layout-content v-if="mainData.projectInfo">
          ...
          <n-tabs animated justify-content="space-evenly">
        ...
        <n-layout-content v-else content-class="flex items-center justify-center text-3xl pl-2 font-bold">请选择一个项目</n-layout-content>
      </n-layout>
    </n-layout>
  </div>
</template>
